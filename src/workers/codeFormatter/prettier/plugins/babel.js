  ...
  var qi = new Set([103, 109, 115, 105, 121, 117, 100, 118]),
    ...
    ot = class extends rt {
      ...
      skipBlockComment(t) {
        ...
        for (
          this.state.pos = i + t.length, Ee.lastIndex = s + 2;
          Ee.test(this.input) && Ee.lastIndex <= i;
    ...
    sr = (a) =>
      class extends a {
        ...
        flowParseObjectType({
          ...
          for (
            ...
            if (this.eat(0))
              ...
              let Ce = this.flowParseObjectTypeProperty(
                C,
                d,
                x,
                E,
        ...
        flowEnumErrorStringMemberInconsistentlyInitialized(e, { enumName: s }) {
          this.raise(g.EnumStringMemberInconsistentlyInitialized, {
            at: e,
            enumName: s,
          });
        }
  ...
  var xt = class extends yt {
      ...
      parseExprOp(t, e, s) {
        if (this.isPrivateName(t)) {
          ...
          (s >= Ne(58) || !this.prodParam.hasIn || !this.match(58)) &&
      ...
      parseSubscript(t, e, s, i) {
        ...
        if (Me(r)) return this.parseTaggedTemplateExpression(t, e, i);
        let n = !1;
        if (r === 18) {
          if (
            s &&
...
`,
      ...
      parseMethod(t, e, s, i, r, n, o = !1) {
        this.initFunction(t, s),
          ...
          this.prodParam.enter(ve(s, t.generator)),
  ...
  var Pt = class extends xt {
      ...
      parseFunction(t, e = 0) {
        ...
        return (
          (this.state.maybeInArrowParameters = !1),
          this.scope.enter(2),
          this.prodParam.enter(ve(n, t.generator)),
...
function we(a) {
  ...
  return (Se = we.prototype = a ?? Object.create(null)), new we();
}
var Qr = 10;
for (let a = 0; a <= Qr; a++) we();
function Dt(a) {
  return we(a);
}
  ...
  return function (s) {
    ...
    try {
      ...
      throw (r == null ? void 0 : r.reasonCode) === "MissingPlugin" ||
        ...
        ? be({ message: "Unexpected token", loc: r.loc })
        : be(r);
    }
